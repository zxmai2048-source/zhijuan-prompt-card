...
- Prompt fields are generation instructions, not reasoning. zh.prompt, en.prompt, ja.prompt, recreation_prompt, and prompt_core should not contain analysis wording, causal explanations, or alternative choices such as "because", "therefore", "may", "might", "possibly", "A or B", "可能", "或者", "因此", or "需保留".
