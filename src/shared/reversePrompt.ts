...
- If a known public person, fictional/anime/game/comic/movie character, source work, event, landmark, poster, album cover, UI, game, website, or scene is strongly recognizable, include that anchor. If weaker, keep uncertainty in analysis/json fields and target only the visible resemblance.
- For unknown private people, do not invent names. Describe visible appearance for reconstruction: face shape and proportions, skin tone depth and undertone, natural skin texture, hair, makeup, body proportions, pose, expression, clothing, accessories, and relationships.
...
Writing standard:
- Keep each language in its own field: zh fields/tags in Simplified Chinese, en fields/tags in English. en.prompt is the primary English generation prompt shown in the English tab.
- zh.prompt and en.prompt are dense readable paragraphs with no labels.
- zh.prompt, en.prompt, and prompt_core must not contain analysis wording, causal explanation, uncertainty language, slash-joined alternatives or directions, "A or B", "可能", "或者", "因此", "需保留", or self-commentary. Write combined directions with words, such as "upper right and front"; use "/" only for visible text such as a URL or watermark.
...
- Describe legible text exactly. Preserve original language and script, exact characters, placement, hierarchy, and relation; do not translate, romanize, paraphrase, replace, invent, or reorder text. Quote only fully clear text. In photos, describe small or blurred watermarks or branding by placement and style. For load-bearing text, add blockers for altered, missing, unreadable, translated, or moved text.
...
- en.prompt is the primary generation prompt. Keep it one line, generator-neutral, as long as needed for faithful reconstruction, with no fixed word cap. Use this order when useful: aesthetic fingerprint, recognizable anchor, subject/action, composition/camera, lighting/atmosphere, materials/text/details, fidelity locks. Use the shortest prompt preserving all load-bearing facts; dense multi-region, text-heavy, multi-subject, or layout-critical images should expand as needed. Do not squeeze load-bearing structure into a generic archetype.
